...
<head>
	...
	<title>AuthMyApp Subscription Canceled</title>
	<style type="text/css">
...
<body>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" border="0" align="center" style='font-family:Helvetica,Arial,Verdana,sans-serif;font-size:14px; margin: 0px auto; background-color: #d1d1d1;'>
			<tr>
				<td colspan="5" style='padding-bottom: 20px; padding-top: 20px; text-align: center;'>
					<img src="<?php echo URL::base(TRUE).'assets/img/logo_small.png' ?>" class="image_fix" style='margin: 0px auto; margin-bottom: 15px'>
					<hr />
				</td>
			</tr>
			<tr>
				<td width="24" height='20' valign="top"></td>
				<td width="184" height='20' valign="top">Dear <?php echo $user->first_name() ?>,</td>
				<td width="184" height='20' valign="top"></td>
				<td width="184" height='20' valign="top"></td>
				<td width="24" height='20' valign="top"></td>
			</tr>
			<tr>
				<td width="24" height='100' valign="top"></td>
				<td colspan="3" valign="top" height="100" width='570'>
					<p>
						There was a problem charging your credit card for you AuthMyApp payment. Your subscription has been canceled and your data transfers have been placed on hold. To fix this issue, please subscribe to a new plan with a new credit card.
					</p>
					<p>
						If you have any questions, please contact us at hello@authmyapp.com.
					</p>
				</td>
				<td width="24" height='20' valign="top"></td>
			</tr>
			<tr>
				...
				<td colspan="2" width="368" valign="top" style='padding-top: 15px; padding-bottom: 20px;'>
					<strong>
						Your AuthMyApp subscription plan has been canceled
					</strong>
				</td>
				<td width="184" height='75' valign="top">
					<a href="<?php echo URL::base(TRUE).'/home/plans' ?>" style="background-color:hsl(214, 64%, 36%);border:1px solid #005a93!important;border-collapse:collapse;border-radius:3px;display:block;color:#fff;font-family:helvetica,arial,Verdana,sans-serif;font-size:14px;line-height:1;margin:4px auto;outline:none;padding:12px 0px;text-align:center;text-decoration:none;width:180px;border-width:0;min-height:14px" target="_blank">
						Re-Subscribe
					</a>
				</td>
				<td width="24" valign="top"></td>
		...
		<!-- <a href="http://htmlemailboilerplate.com" target ="_blank" title="Styling Links" style="color: orange; text-decoration: none;"></a> -->
