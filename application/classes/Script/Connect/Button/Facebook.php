...
class Script_Connect_Button_Facebook extends Script_Abstract {
	...
	public function set_file_data()
	{
		...
		<a href="'.$this->app->sender_url().'?data_source=facebook&button_version='.Controller_Api_Abstract::CONNECT_VERSION.'" class="btn-facebook" target="_top">'.$this->data['text'].'</a>
